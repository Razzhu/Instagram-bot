#!/usr/bin/env python3
"""
Instagram Group Bot - FIXED ADMIN TAG RESPONSE
Bot responds when users tag admin, NOT when bot tags admin itself
"""
...
ADD_MSG = "✅ {username} added to the group by @{admin}!"
FAILED_ADD_MSG = "❌ Failed to add @{username}. Make sure they exist and the bot can add them."
...
# ✅ Admin tag replies (when SOMEONE tags admin)
ADMIN_TAG_REPLIES = [
...
class InstagramGroupBot:
    ...
    def kick_user(self, thread_id, target_id):
        try:
            ...
            try:
                self.cl.direct_thread_remove_user(thread_id_int, [target_id_int])
            ...
            try:
                self.cl.direct_thread_remove_user(str(thread_id_int), [str(target_id_int)])
                print("✅ Kick successful (method 2)!")
                return True
            except Exception as e:
                print(f"⚠️ Method 2 failed: {e}")
            
            try:
                self.cl.direct_remove_user(thread_id_int, target_id_int)
                print("✅ Kick successful (method 3)!")
                return True
            except Exception as e:
            ...
            try:
                ...
                print("✅ Kick successful (method 4)!")
                return True
            except Exception as e:
...
"""
            ...
            for thread in threads:
                ...
                try:
                    ...
                    for msg in thread_detail.messages:
                        ...
                        # ✅ ADMIN TAG DETECTION - ONLY FOR REAL USERS (NOT BOT)
                        ...
                        # Admin greeting (when admin types)
    ...
    def run(self):
        ...
        print("📌 Admin tag replies: Enabled (only for users)")
