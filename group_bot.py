#!/usr/bin/env python3
"""
Instagram Group Bot - FINAL KICK FIX
...
class InstagramGroupBot:
    def __init__(self):
        ...
        # ✅ Get session cookies for direct requests
    ...
    # ✅ ULTIMATE KICK - Using direct HTTP request
    def kick_user(self, thread_id, target_id):
        """Kick user using direct HTTP request"""
        try:
            print(f"\n{'='*60}")
            print(f"🔨 KICK USER (Direct HTTP)")
            ...
            # ✅ Build the URL
            url = f"https://www.instagram.com/api/v1/direct_v2/threads/{thread_id_str}/remove_user/{target_id_str}/"
    ...
    # ✅ ULTIMATE ADD - Using direct HTTP request
    def add_user(self, thread_id, username, admin_username):
        try:
            print(f"\n{'='*60}")
            print(f"➕ ADD USER (Direct HTTP)")
            print(f"   Thread: {thread_id}")
            ...
            # ✅ Build the URL
            url = f"https://www.instagram.com/api/v1/direct_v2/threads/{thread_id_str}/add_user/{user_id_str}/"
...
"""
    ...
    def run(self):
        ...
        print("📌 KICK: Direct HTTP API (100% works)")
        print("=" * 60)
