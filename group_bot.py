...
- Tag the person being replied to
- Low reply chance (10-15%)
- Savage + Rude + Funny tone
- Hindi/Hinglish
...
# ✅ Anti-detection: Low reply chance (10-15%)
NATURAL_REPLY_CHANCE = random.uniform(0.10, 0.15)
...
# ✅ SAVAGE + RUDE + FUNNY prompts (with tagging)
...
**🤖 AI Mode:**
Bot replies naturally in Hindi (10-15% chance)
"""
            ...
            for thread in threads:
                ...
                try:
                    ...
                    for msg in detail.messages:
                        ...
                        # ============================================================
                        # ✅ GROQ NATURAL REPLY (10-15% chance) with tagging
                        # ============================================================
