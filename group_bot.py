...
- Spam: Custom count up to 20 with 2s delay
- Kick: Fixed method
- Admin tag replies
- More fun commands!
"""
...
MAX_WARNINGS = 3
POLL_INTERVAL = 10
MAX_SPAM_COUNT = 20  # ✅ Max spam messages
SPAM_DELAY = 2  # ✅ 2 second delay between spam
...
MEMES = [
    ...
    "🤡 Me trying to understand my own code",
...
# ✅ Admin greeting messages (when admin types)
ADMIN_GREETINGS = [
    "👑 Welcome back boss!",
    "🙇‍♂️ At your service, my lord!",
    "👋 Hey boss! Good to see you!",
    "🫡 Reporting for duty, sir!",
    "🤖 Bot is ready for your commands, boss!",
...
class InstagramGroupBot:
    def __init__(self):
        ...
        self.trivia_state = {}
        self.admin_last_greeting = {}  # {thread_id: timestamp}
...
"""
        ...
        if cmd == '/kick':
            ...
            for i in range(count):
                ...
                time.sleep(SPAM_DELAY)  # ✅ 2 second delay
            ...
            for thread in threads:
                ...
                try:
                    ...
                    for msg in thread_detail.messages:
                        ...
                        for admin in ADMINS:
                            if f"@{admin}" in msg_lower and username.lower() != admin.lower():
                        ...
                        if username.lower() in [a.lower() for a in ADMINS]:
                            # Check if we haven't greeted in the last 5 minutes
                            last_greeting = self.admin_last_greeting.get(thread_id, datetime.now() - timedelta(minutes=10))
                            if (datetime.now() - last_greeting).seconds > 300:  # 5 minutes
                        ...
                        if user_id in AFK_USERS:
                            afk_reason, afk_time = AFK_USERS[user_id]
                            if (datetime.now() - afk_time).seconds > 300:  # 5 minutes
